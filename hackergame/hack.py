...
with open('hackergame/sevenletterwords.txt') as wordListFile:
...
def hack():
    print("hack v0.9.1")
    print("This program is provided with ABSOLUTELY NO WARRANTY, WITHOUT EVEN THE IMPLIED WARRANTY... that it might actually be useful.")
    print("Hacking IP: 124.23.76.135 (1591.bd-east.bigbank.gov.bd)")
    ...
    for triesRemaining in range(5, 0, -1):
        ...
        if playerMove == secretPassword:
            ...
            print('Access Denied (password hint: {}/7 correct)'.format(numMatches))
    print('Out of tries.')


def getWords():
    """Return a list of 7 words that could possibly be the password.
